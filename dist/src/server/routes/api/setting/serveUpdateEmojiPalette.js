...
exports.serveUpdateEmojiPalette = void 0;
...
function serveUpdateEmojiPalette(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { userParmId } = req;
        const { emojiPalette } = req.body;
        try {
            const isPremium = yield (0, dbCheckIfPremiumUser_1.dbCheckIfPremiumUser)(req.mongoose, userParmId);
            if (!isPremium) {
...
exports.serveUpdateEmojiPalette = serveUpdateEmojiPalette;
