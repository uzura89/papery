...
function serveStripeWebhook(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const stripeEvent = yield StripeHandler_1.default.retrieveStripeEvent(req);
...
function onCheckoutSessionCompleted(stripeEvent) {
    return __awaiter(this, void 0, void 0, function* () {
        const stripeSession = yield StripeHandler_1.default.retrieveCheckoutSession(stripeEvent);
        ...
        if (!priceItem.isRecurring) {
            yield (0, dbPurchaseOnetime_1.dbPurchaseOnetime)(mongoose_1.default, stripeSession.customer_email, {
            ...
            const subscription = yield StripeHandler_1.default.retrieveSubscription(stripeSession.subscription);
            if (!subscription || typeof subscription.current_period_end !== "number") {
                throw new Error("Subscription not found");
            }
            yield (0, dbPurchaseSubscription_1.dbPurchaseSubscription)(mongoose_1.default, stripeSession.customer_email, {
                customerId: stripeSession.customer,
                purchaseId: stripeSession.id,
                purchasePlan: priceItem.title,
...
function onCustomerSubscriptionUpdated(stripeEvent) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const customer = yield StripeHandler_1.default.retrieveCustomerFromSubscription(subscription);
        // handle customer.subscription.updated event
        yield (0, dbUpdateSubscription_1.dbUpdateSubscription)(mongoose_1.default, customer.id, {
            subscriptionCurrentPeriodEnd: subscription.current_period_end * 1000,
            subscriptionCancelAtPeriodEnd: subscription.cancel_at_period_end,
        });
    });
...
function onCustomerSubscriptionDeleted(stripeEvent) {
    return __awaiter(this, void 0, void 0, function* () {
        const subscription = stripeEvent.data.object;
        const customer = yield StripeHandler_1.default.retrieveCustomerFromSubscription(subscription);
        yield (0, dbRemovePremiumFromUser_1.dbRemovePremiumFromUser)(mongoose_1.default, customer.id);
    });
}
